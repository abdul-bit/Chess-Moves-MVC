...
public class Model extends Observable implements IModel {
        ...
        public ArrayList getPos() {
                ...
                if (this.Piece.equals("King")) {
                        ...
                        while (((this.Pos.charAt(0) - i) >= 97)) {
                                possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0) - i)))
                                                + String.valueOf((char) ((this.Pos.charAt(1)))));
                                i = i + 1;
                        }
                        i = 1;
                        while (((this.Pos.charAt(0) + i) <= 104)) {
                                possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0) + i)))
                                                + String.valueOf((char) ((this.Pos.charAt(1)))));
                                i = i + 1;
                        ...
                        i = 1;
                        while (((this.Pos.charAt(1) + i) <= 56)) {
                                possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0))))
                                                + String.valueOf((char) ((this.Pos.charAt(1) + i))));
                                i = i + 1;
                        }
                        i = 1;
                        while (((this.Pos.charAt(1) - i) >= 49)) {
                                possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0))))
                                                + String.valueOf((char) ((this.Pos.charAt(1) - i))));
                                i = i + 1;
                        }
                        ...
                        possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0) + 2)))
                                        + String.valueOf((char) ((this.Pos.charAt(1) + 1))));
                        possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0) + 2)))
                                        + String.valueOf((char) ((this.Pos.charAt(1) - 1))));
                        possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0) - 2)))
                        ...
                        possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0) + 1)))
                                        + String.valueOf((char) ((this.Pos.charAt(1) + 2))));
                        possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0) + 1)))
                                        + String.valueOf((char) ((this.Pos.charAt(1) - 2))));
                        possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0) - 1)))
                                        + String.valueOf((char) ((this.Pos.charAt(1) + 2))));
                ...
                } else if (this.Piece.equals("Black Pawn")) {
                        if (this.Pos.charAt(1) == 55) {
                                possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0))))
                                                + String.valueOf((char) ((this.Pos.charAt(1) - 2))));
                                possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0))))
                                                + String.valueOf((char) ((this.Pos.charAt(1) - 1))));
                ...
                } else if (this.Piece.equals("White Pawn")) {
                        if (this.Pos.charAt(1) == 50) {
                                possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0))))
                                                + String.valueOf((char) ((this.Pos.charAt(1) + 2))));
                                possiblemoves.add(String.valueOf((char) ((this.Pos.charAt(0))))
                                                + String.valueOf((char) ((this.Pos.charAt(1) + 1))));
